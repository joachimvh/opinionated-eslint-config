...
// eslint-disable-next-line ts/no-require-imports,ts/no-var-requires,ts/no-unsafe-assignment,max-len
const jest: Record<string, never> & { configs: { all: { rules: Record<string, unknown> }}} = require('eslint-plugin-jest');
